...
export const ProductCard = ({ productData, onPress }: ProductCardProps) => {
  const theme = useTheme();
  return (
    <S.ProductCard>
      <S.ProductHeader>
        <Feather color={theme.primaryColor} name="settings" size={24} />
      ...
      <Button btnText="Assinar" onPress={() => onPress(productData.priceId)} />
    </S.ProductCard>
  );
};
